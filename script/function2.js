...
func1(1,2)
//ES6 화살표함수
//화살표함수는 function 키워드가 생략되므로 function 뒤에 작성하는 함수이름도 쓸 수 없기 때문에 익명함수라고 부른다. 대신 함수는 함수이름으로 호출하지 않으면 사용할 수 없기 떄문에 function 뒤에 작성하던 함수명을 const 또는 let을 활용하여 변수로 대신 사용한다.
...
//함수명 dan99
//매개변수 반드시 1개 이상 생성
//변수, 복합대입연산자 +=, 태그 내용 삽입 속성 innerText ? innerHTML?
...
//경고버튼을 클릭 시 p.result 위치에 '잘못클릭하셨습니다' 함수의 경고메시지 출력
