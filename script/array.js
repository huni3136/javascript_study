...
console.log(yoil_v2)
console.log(yoil_v2[1]) //undifined
yoil_v2[1] = '월'
console.log(yoil_v2)
yoil_v2[0] = '일'
...
//콘솔결과예) 좋아하는 색상은 0, 0 입니다.
let color = ['빨강','주황','노랑','초록','파랑','남색']
console.log(`좋아하는 색상은 ${color[0]},${color[4]} 입니다.`)
//2. 좋아하는 과일을 5개 배열로 저장하고 모두 역순으로 출력해보세요.
const fruit = ['사과','바나나','딸기','포도','망고']
//역순 출력
const result = fruit.reverse(); 
...
lottecinema.push('A1','A2')
console.log(lottecinema)
lottecinema.push('C2','C3')
console.log(lottecinema)
lottecinema.pop()
console.log(lottecinema)
lottecinema.unshift('A0')
console.log(lottecinema)
lottecinema.shift()
console.log(lottecinema) */
let lottecinema = []
...
// 결제 하기 클릭 후 메시지 출력
/* console.log(`예매하신 좌석은 총 ${lottecinema.length} 좌석이며 성인 1명당 ${price}원 기준으로 총 결제 금액은 ${price * lottecinema.length}원 입니다.`) */
total_func()
function total_func(){
    total = `예매하신 좌석은 총 ${lottecinema.length} 좌석이며 성인 1명당 ${price}원 기준으로 총 결제 금액은 ${price * lottecinema.length}원 입니다.`
    console.log(total)
}