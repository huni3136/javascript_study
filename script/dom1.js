...
//() 선택하는 "태그명" 작성
//객체.메서드()
//선택한 DOM태그내에서 자식, 자손까지 포함해서 선택한다.
...
const li_menu1 = gnbCls[0].getElementsByTagName('li')
console.log(li_menu1[0])
//3. li_menu2 : gnb의 두번째 자식 li 잡기
const li_menu2 = gnbCls[0].getElementsByTagName('li')
console.log(li_menu2[3])
