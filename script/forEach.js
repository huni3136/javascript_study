...
console.log(nav_a[0])
//(위) [index]를 사용함으로써 개별접근을 해서 다양한 기능수행이 가능하지만 개수가 많을 때 반복입력을 해야 해서 비효율적이다. 이 문제를 해결하는게 '반복문' 이다!
//for (ES5)
...
//let a =document... // for~in => 0 1 2 3 ..고유 속성
...
nav_a.forEach((target, index)=>{
    ...
    target.addEventListener('mouseover',()=>{
        ...
        //for(let i of sub){i.style.backgroundColor='#fff'}
...
subHide()
//forEach gnb 마우스 올렸을때 각각의 sub 출력
gnb.forEach((t, i)=>{
