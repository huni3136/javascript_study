...
//clasName은 속성으로 대입연산자를 이용한다.
li[1].className = 'set1'
li[1].className += ' set2'
//classList 메서드 방법(대입연산자가 아니기 떄문에 className보다 주의해야할 사항이 적다)
li[2].classList.add('set1')
li[2].classList.add('set2')
li[2].classList.remove('set2')
// 추가 연습 4~6
li[3].classList.add('detail')
li[3].classList.add('set2')
li[4].classList.add('menu')
li[5].classList.add('menu')
li[5].classList.add('set2')
