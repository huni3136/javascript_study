...
//삼항 조건 ver2 userpw
let number = userpw == 1234 ? '로그인성공' : '로그인실패'
console.log(number)
///-----------논리연산+
//&&(and) 모두 참일 때 참
//||(or) 하나라도 참이면 참
...
let num = 5 /* prompt('1~20 사이 중 좋아하는 수를 입력하세요') */
...
let score = 100 /* prompt('0~100 사이 입력하세요') */
let total = ""
...
console.log(year,month,day,btn)
